...
INSERT INTO `appointments` (`appointment_id`, `appointment_code`, `patient_id`, `service_id`, `dentist_id`, `requested_date`, `requested_start_time`, `requested_end_time`, `final_date`, `final_start_time`, `final_end_time`, `status`, `payment_status`, `approval_notes`, `cancellation_reason`, `reschedule_reason`, `patient_concern`, `created_by_patient`, `last_updated_by`, `created_at`, `updated_at`) VALUES
(1, 'APP-1775032706', 1, 4, 1, '2026-04-08', '09:00:00', '10:00:00', NULL, NULL, NULL, 'rejected', 'rejected', NULL, NULL, NULL, NULL, 2, 1, '2026-04-01 08:38:26', '2026-04-03 22:39:03'),
(2, 'APP-1775036756', 1, 4, 1, '2026-04-02', '09:50:00', '10:50:00', NULL, NULL, NULL, 'completed', 'verified', NULL, NULL, NULL, NULL, 2, 1, '2026-04-01 09:45:56', '2026-04-03 23:07:19'),
(3, 'APP-1775228591', 1, 4, 1, '2026-04-09', '09:00:00', '10:00:00', NULL, NULL, NULL, 'completed', 'verified', NULL, NULL, NULL, NULL, 2, 1, '2026-04-03 15:03:11', '2026-04-03 22:47:44'),
(4, 'APP-1775255269', 1, 6, 1, '2026-04-05', '09:00:00', '10:00:00', NULL, NULL, NULL, 'rejected', 'rejected', NULL, NULL, NULL, NULL, 2, 1, '2026-04-03 22:27:49', '2026-04-03 22:38:15'),
(5, 'APP-1775284725', 1, 4, 1, '2026-04-04', '16:00:00', '17:00:00', NULL, NULL, NULL, 'completed', 'verified', NULL, NULL, NULL, NULL, 2, 1, '2026-04-04 06:38:45', '2026-04-04 06:39:39'),
(6, 'APP-1775284915', 2, 4, 1, '2026-04-09', '16:00:00', '17:00:00', NULL, NULL, NULL, 'approved', 'pending', NULL, NULL, NULL, NULL, 3, 1, '2026-04-04 06:41:55', '2026-04-04 06:42:41');
...
(1, 2, 'pending', 'approved', 1, 'Appointment approved by admin/staff', '2026-04-03 04:18:55'),
(2, 3, 'pending', 'approved', 1, 'Appointment approved by admin/staff', '2026-04-03 15:05:55'),
(3, 1, 'pending', 'rejected', 1, 'Appointment rejected by admin/staff', '2026-04-03 21:56:07'),
(4, 4, 'pending', 'rejected', 1, 'Appointment rejected by admin/staff', '2026-04-03 22:38:15'),
(5, 2, 'approved', 'completed', 1, 'Appointment marked as completed by admin/staff', '2026-04-03 22:47:28'),
(6, 3, 'approved', 'completed', 1, 'Appointment marked as completed by admin/staff', '2026-04-03 22:47:44'),
(7, 5, 'pending', 'approved', 1, 'Appointment approved by admin/staff', '2026-04-04 06:39:29'),
(8, 5, 'approved', 'completed', 1, 'Appointment marked as completed by admin/staff', '2026-04-04 06:39:34'),
(9, 6, 'pending', 'approved', 1, 'Appointment approved by admin/staff', '2026-04-04 06:42:41');
...
INSERT INTO `dentist_availability` (`availability_id`, `dentist_id`, `day_of_week`, `start_time`, `end_time`, `slot_limit`, `is_active`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 1, 'Wednesday', '09:00:00', '17:00:00', 3, 1, 1, '2026-04-01 09:43:52', '2026-04-01 09:43:52'),
(2, 1, 'Thursday', '09:50:00', '22:00:00', 6, 1, 1, '2026-04-01 09:44:59', '2026-04-01 09:44:59');
...
INSERT INTO `medical_notes` (`note_id`, `patient_id`, `appointment_id`, `encoded_by`, `note_type`, `chief_complaint`, `diagnosis`, `treatment_plan`, `prescription`, `note_text`, `is_confidential`, `created_at`, `updated_at`) VALUES
(1, 1, NULL, 1, 'treatment_note', NULL, NULL, 'Tooth Canal', NULL, '67 67 67 67 hahaha', 0, '2026-03-31 19:18:29', '2026-04-01 08:56:33'),
(2, 2, NULL, 6, 'treatment_note', NULL, NULL, 'Teeth', NULL, 'HHAHAH', 0, '2026-04-01 08:56:46', '2026-04-01 08:56:46');
...
(2, 3, 'Harlene', 'Morcilla', 'Bautista', 'female', '2003-06-27', 'Unit 1507 Cityland Makati Executive Tower 4\r\n77 Sen. Gil Puyat, Pio Del Pilar', 'Ken Edward Latido', '09777416394', NULL, '2026-03-31 18:23:53', '2026-03-31 18:23:53'),
...
(1, 5, 1000.00, 'other', NULL, NULL, '2026-04-04 00:00:00', 'verified', 1, 'Payment verified by admin/staff', '2026-04-04 06:39:29', '2026-04-04 06:39:39'),
(2, 6, 1000.00, 'other', NULL, NULL, NULL, 'pending', NULL, NULL, '2026-04-04 06:42:41', '2026-04-04 06:42:41');
...
(4, 'Teeth Cleaning', 'matalap', '../assets/services/teeth-cleaning.jpeg', 60, 1000.00, 1, 1, '2026-03-31 16:26:37', '2026-04-03 21:20:45'),
(6, 'Dental Cleaning', 'linis', '../assets/services/1775252341_teeth-cleaning.jpeg', 60, 1000.00, 1, 1, '2026-04-03 21:33:34', '2026-04-03 21:39:01');
...
(2, 'patient', 'latidokenedwardendaya@gmail.com', '09777416394', '$2y$10$puPgmL5iBmG0hK0pr0JpQOHEw0jjLEqvwdcJFfxN9GvRjGuK0Gu.S', 'active', 0, '2026-03-31 09:11:38', '2026-03-31 09:11:38'),
